...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getMedia() async {
    try {
      ...
      MediaFile imageMediaFile1 = await FlutterMultiMediaPicker.getMediaFile(
          fileId: imageMediaFileList[0].id, type: MediaType.IMAGE);
      print("imageMediaFile1");
      print(imageMediaFile1.thumbnailPath);

      MediaFile videoMediaFile1 = await FlutterMultiMediaPicker.getMediaFile(
      ...
      if (imageMediaFileList.length > 0) {
        String imageMediaFile2 = await FlutterMultiMediaPicker.getThumbnail(
            fileId: imageMediaFileList[0].id, type: MediaType.IMAGE);
      ...
      if (videoMediaFileList.length > 0) {
        String videoMediaFile2 = await FlutterMultiMediaPicker.getThumbnail(
            fileId: videoMediaFileList[0].id, type: MediaType.VIDEO);
